...
LOGGER_ID = int(getenv("LOGGER_ID", -1002192014624))
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/love_angel_world")
...
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://files.catbox.moe/0dleda.jpg"
)
